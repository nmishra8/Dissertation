...
\begin{figure*}
\begin{center}
 \includegraphics[width=0.9\textwidth]{barplotPerformance.png}
 %\vspace{-7em}
 \vspace{-0.35em}
...
\begin{figure*}
\begin{center}
 \includegraphics[width=0.9\textwidth]{barplotPower.png}
 \vspace{-0.35em}
...
\end{tabular}
\vspace{-0.35em}
\caption{Examples of performance estimation using \SYSTEM{}.  Performance is measured as application iterations (or heartbeats) per second. (See \secref{setup}).}
\label{fig:perf}
...
\end{tabular}
\vspace{-0.35em}
\caption{Examples of power estimation using \SYSTEM{}. Power is
...
performance feedback to \SYSTEM{} \cite{Heartbeats1,Heartbeats2}. Thus
\SYSTEM{} is ensured of optimizing the performance that matters to the
...
To evaluate \SYSTEM{} quantitatively, we measure the \emph{accuracy}
...
\begin{figure*}
\begin{center}
 \includegraphics[width=0.9\textwidth]{barplotEnergy.png}
 %\vspace{-0.35em}
...
Despite this behavior, \SYSTEM{} produces highly accurate estimates of
...
target.  As described in \Secref{sec:EMalg}, \SYSTEM{} uses its estimates to
...
One of the key parameters of \SYSTEM{} is the number of samples it must
...
\begin{tabular}[h]{cc}\hspace*{-15pt}     
	 \includegraphics[width=0.235\textwidth]{AllSamplePerf.png}& 
	\includegraphics[width=0.235\textwidth]{AllSamplePower.png}\\
	 {(a)} &
	 {(b)}
\end{tabular}
\end{center}
...
\PUNT{ \SYSTEM{}'s runtime overhead is tricky to quantify.  } The
