%Title: \SYSTEM{}: A machine learning approach to minimizing energy under performance constraints
...
In this paper, we present \SYSTEM{} (Learning for Energy
...
\Secref{sec:poc}).  On average, \SYSTEM{} is within 97\% of the true
...
parameters of this problem.  \Secref{sec:HBN} elaborates our probabilistic graphical model and describes \SYSTEM{} in full detail.
\Secref{sec:experiment} presents empirical studies on \SYSTEM{}.
