...
\addplot[color=on,fill=on]  table[x index=0,y index=3, col sep=space] {img/image_text/ma-err-0.4-v2.txt};
\addplot[color=off,fill=off]  table[x index=0,y index=4, col sep=space] {img/image_text/ma-err-0.4-v2.txt};
\addplot[color=leo,fill=leo]  table[x index=0,y index=5, col sep=space] {img/image_text/ma-err-0.4-v2.txt};
\addplot[color=poet,fill=poet]  table[x index=0,y index=6, col sep=space] {img/image_text/ma-err-0.4-v2.txt};
\addplot[color=calnp,fill=calnp]  table[x index=0,y index=7, col sep=space] {img/image_text/ma-err-0.4-v2.txt};
\addplot[color=cal,fill=cal]  table[x index=0,y index=8, col sep=space] {img/image_text/ma-err-0.4-v2.txt};
...
\addplot[color=on,fill=on]  table[x index=0,y index=3, col sep=space] {img/image_text/ma-err-0.6-v2.txt};
\addplot[color=off,fill=off]  table[x index=0,y index=4, col sep=space] {img/image_text/ma-err-0.6-v2.txt};
\addplot[color=leo,fill=leo]  table[x index=0,y index=5, col sep=space] {img/image_text/ma-err-0.6-v2.txt};
\addplot[color=poet,fill=poet]  table[x index=0,y index=6, col sep=space] {img/image_text/ma-err-0.6-v2.txt};
\addplot[color=calnp,fill=calnp]  table[x index=0,y index=7, col sep=space] {img/image_text/ma-err-0.6-v2.txt};
\addplot[color=cal,fill=cal]  table[x index=0,y index=8, col sep=space] {img/image_text/ma-err-0.6-v2.txt};
...
\addplot[color=on,fill=on]  table[x index=0,y index=3, col sep=space] {img/image_text/ma-err-0.8-v2.txt};
\addplot[color=off,fill=off]  table[x index=0,y index=4, col sep=space] {img/image_text/ma-err-0.8-v2.txt};
\addplot[color=leo,fill=leo]  table[x index=0,y index=5, col sep=space] {img/image_text/ma-err-0.8-v2.txt};
\addplot[color=poet,fill=poet]  table[x index=0,y index=6, col sep=space] {img/image_text/ma-err-0.8-v2.txt};
\addplot[color=calnp,fill=calnp]  table[x index=0,y index=7, col sep=space] {img/image_text/ma-err-0.8-v2.txt};
\addplot[color=cal,fill=cal]  table[x index=0,y index=8, col sep=space] {img/image_text/ma-err-0.8-v2.txt};
