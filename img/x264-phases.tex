...
\addplot[thick, solid, color=ADAPT-CONTROL, mark=none,each nth point=2] table[x index=0,y index=1,col sep=space] {img/x264-native-ducks/poet-x264.txt};
...
\addplot[thick, solid, color=HBM-ADAPT, mark=none,each nth point=2] table[x index=0,y index=1,col sep=space] {img/x264-native-ducks/leopoet-x264.txt};
...
\addplot[thick, solid, color=ADAPT-CONTROL, mark=none,each nth point=2] table[x index=0,y index=2,col sep=space] {img/x264-native-ducks/poet-x264.txt};
...
\addplot[thick, solid, color=HBM-ADAPT, mark=none,each nth point=2] table[x index=0,y index=2,col sep=space] {img/x264-native-ducks/leopoet-x264.txt};
